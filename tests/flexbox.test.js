...
const tests = {
	...
	"flexbox-space-between-flex-start-space-evenly": ["flex", "space-between", "flex-start", "space-evenly", "unset", "unset"],
	"flexbox-first-baseline-space-around-space-evenly": ["flex", "first baseline", "space-around", "space-evenly", "unset", "unset"],
	...
	"flexbox-safe-space-around-unsafe-center": ["flex", "safe space-around", "unsafe center", "unset", "unset", "unset"],
	"flexbox-safe-space-evenly-last-baseline": ["flex", "safe space-evenly", "last baseline", "unset", "unset", "unset"],
	...
	"flexbox-safe-space-around-stretch-unsafe-center": ["flex", "safe space-around", "stretch", "unsafe center", "unset", "unset"],
	"flexbox-safe-space-around-unsafe-self-start-safe-start": ["flex", "safe space-around", "unsafe self-start", "safe start", "unset", "unset"],
	...
	"flexbox-column-reverse-stretch-center-flex-start": ["flex", "stretch", "center", "flex-start", "column-reverse", "unset"],
	"flexbox-row-center-self-start-center": ["flex", "center", "self-start", "center", "row", "unset"],
	"flexbox-space-around-stretch-center-row-reverse": ["flex", "space-around", "stretch", "center", "row-reverse", "unset"],
	"flexbox-column-baseline-space-between-center": ["flex", "baseline", "space-between", "center", "column", "unset"],
	"flexbox-space-between-space-around-center-column-reverse": ["flex", "space-between", "space-around", "center", "column-reverse", "unset"],
	"flexbox-first-baseline-space-around-space-evenly-row": ["flex", "first baseline", "space-around", "space-evenly", "row", "unset"],
	...
	"flexbox-column-reverse-flex-end-start-safe-end": ["flex", "flex-end", "start", "safe end", "column-reverse", "unset"],
	...
	"flexbox-stretch-space-between-wrap-reverse": ["flex", "stretch", "space-between", "unset", "unset", "wrap-reverse"],
	...
	"flexbox-wrap-reverse-center-self-start-center": ["flex", "center", "self-start", "center", "unset", "wrap-reverse"],
	...
	"flexbox-space-between-space-around-center-wrap-reverse": ["flex", "space-between", "space-around", "center", "unset", "wrap-reverse"],
	"flexbox-first-baseline-space-around-space-evenly-wrap": ["flex", "first baseline", "space-around", "space-evenly", "unset", "wrap"],
	...
	"flexbox-column-reverse-wrap-reverse-space-between": ["flex", "space-between", "unset", "unset", "column-reverse", "wrap-reverse"],
	...
	"flexbox-row-reverse-stretch-space-between-wrap-reverse": ["flex", "stretch", "space-between", "unset", "row-reverse", "wrap-reverse"],
	"flexbox-space-evenly-last-baseline-wrap-column": ["flex", "space-evenly", "last baseline", "unset", "column", "wrap"],
	"flexbox-column-reverse-nowrap-stretch-center-flex-start": ["flex", "stretch", "center", "flex-start", "column-reverse", "nowrap"],
	"flexbox-row-wrap-reverse-center-self-start-center": ["flex", "center", "self-start", "center", "row", "wrap-reverse"],
	"flexbox-space-around-stretch-center-wrap-row-reverse": ["flex", "space-around", "stretch", "center", "row-reverse", "wrap"],
	"flexbox-column-baseline-space-between-center-nowrap": ["flex", "baseline", "space-between", "center", "column", "nowrap"],
	"flexbox-wrap-reverse-space-between-space-around-center-column-reverse": ["flex", "space-between", "space-around", "center", "column-reverse", "wrap-reverse"],
	"flexbox-first-baseline-space-around-space-evenly-row-wrap": ["flex", "first baseline", "space-around", "space-evenly", "row", "wrap"],
	"flexbox-nowrap-row-reverse-safe-center": ["flex", "safe center", "unset", "unset", "row-reverse", "nowrap"],
	"flexbox-wrap-reverse-stretch-safe-center-column": ["flex", "stretch", "safe center", "unset", "column", "wrap-reverse"],
	"flexbox-column-reverse-flex-end-start-safe-end-wrap": ["flex", "flex-end", "start", "safe end", "column-reverse", "wrap"],

	//inline flexbox
	"flexbox-inline-column": ["inline-flex", "unset", "unset", "unset", "column", "unset"],
	"flexbox-wrap-inline": ["inline-flex", "unset", "unset", "unset", "unset", "wrap"],
	"flexbox-inline-center": ["inline-flex", "center", "unset", "unset", "unset", "unset"],
	"flexbox-flex-start-inline": ["inline-flex", "flex-start", "unset", "unset", "unset", "unset"],
	"flexbox-inline-space-between": ["inline-flex", "space-between", "unset", "unset", "unset", "unset"],
	"flexbox-flex-start-inline-flex-end": ["inline-flex", "flex-start", "flex-end", "unset", "unset", "unset"],
	"flexbox-stretch-center-flex-start-inline": ["inline-flex", "stretch", "center", "flex-start", "unset", "unset"],
	"flexbox-safe-space-around-inline-unsafe-center": ["inline-flex", "safe space-around", "unsafe center", "unset", "unset", "unset"],
	"flexbox-inline-row-reverse-stretch-space-between": ["inline-flex", "stretch", "space-between", "unset", "row-reverse", "unset"],
	"flexbox-space-evenly-inline-last-baseline-column": ["inline-flex", "space-evenly", "last baseline", "unset", "column", "unset"],
	"flexbox-column-reverse-stretch-center-flex-start-inline": ["inline-flex", "stretch", "center", "flex-start", "column-reverse", "unset"],
	"flexbox-wrap-reverse-inline-space-between": ["inline-flex", "space-between", "unset", "unset", "unset", "wrap-reverse"],
